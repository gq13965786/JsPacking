describe('ape.AssetRegistry', () => {
  ...
  it('should create a new ape.AssetRegistry', function () {
    var reg = new ape.AssetRegistry(this.loader);
    expect(reg instanceof ape.AssetRegistry).to.equal(true);
  });
  ...
  it('list() lists all assets', function () {
    var asset1 = new ape.Asset("Asset 1", "text", {
      url: "fake/one/file.txt"
    });
    var asset2 = new ape.Asset("Asset 2", "text", {
      url: "fake/two/file.txt"
    });
    var asset3 = new ape.Asset("Asset 3", "text", {
  ...
  it('remove() remove by id', function () {
    var asset1 = new ape.Asset("Asset 1", "text", {
        url: "fake/one/file.txt"
    });
    var asset2 = new ape.Asset("Asset 2", "text", {
