describe('ape.IndexedList', function () {
  it("new ape.IndexedList", function () {
    var list = new ape.IndexedList();

    expect(list.list().length).to.equal(0);
  });

  it("push, has, get behave as expect", function () {
    var list = new ape.IndexedList();
  ...
  it("get() return null if no key", function () {
    var list = new ape.IndexedList();
