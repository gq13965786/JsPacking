describe('ape.GraphNode-datastruct to entity', function () {
  beforeEach(function () {
    //this.app = new ape.Application(document.createElement('canvas'));
  });
  ...
  function buildGraph() {
    var g1 = new ape.GraphNode();
    g1.name = 'g1';

    var g2 = new ape.GraphNode();
    g2.name = 'g2';

    var g3 = new ape.GraphNode();
    g3.name = 'g3';
  ...
  it('GraphNode: addChild', function () {
    var g1 = new ape.GraphNode('g1');
    var g2 = new ape.GraphNode('g2');
  ...
  it('GraphNode: rotateLocal in hierarchy', function () {
    var p = new ape.GraphNode('parent');
    var g;
    var angles;
