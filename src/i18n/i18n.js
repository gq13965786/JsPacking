Object.assign(ape, (function () {
     ...
     * its default behaviour define a different implementation for {@link ape.I18n#getText} and {@link ape.I18n#getPluralText}.
     * @param {ape.Application} app The application.
     ...
     * @property {Number[]|ape.Asset[]} assets An array of asset ids or assets that contain localization data in the expected format. I18n will automatically load
     ...
     * @private
     * @function
     * @name ape.I18n#removeData
     * @description Removes localization data.
     * @param {Object} data The localization data. The data is expected to be in the same format as {@link ape.I18n#addData}.
     */
