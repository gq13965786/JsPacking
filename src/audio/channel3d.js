Object.assign(ape, function () {
    ...
    if (ape.AudioManager.hasAudioContext()) {
        Channel3d = function (manager, sound, options) {
            ape.Channel.call(this, manager, sound, options);
        ...
        Channel3d.prototype = Object.create(ape.Channel.prototype);
        ...
        Object.assign(Channel3d.prototype, {
             ...
             * @private
             * @function
             * @name ape.Channel3d#_createSource
        ...
        Channel3d = function (manager, sound) {
            ape.Channel.call(this, manager, sound);
            ...
            this.distanceModel = ape.DISTANCE_INVERSE;
        };
        Channel3d.prototype = Object.create(ape.Channel.prototype);
        Channel3d.prototype.constructor = Channel3d;
