Object.assign(ape, function () {
    ...
    if (ape.AudioManager.hasAudioContext()) {
         ...
         * @constructor
         * @name ape.Channel
         * @classdesc A channel is created when the ape.AudioManager begins playback of a ape.Sound. Usually created internally by
         * ape.AudioManager#playSound or ape.AudioManager#playSound3d. Developers usually won't have to create Channels manually.
         * @param {ape.AudioManager} manager The AudioManager instance
         * @param {ape.Sound} sound The sound to playback
    ...
    } else if (ape.AudioManager.hasAudio()) {
        Channel = function (manager, sound, options) {
    ...
    Object.assign(Channel.prototype, {
         ...
         * @private
         * @function
         * @name ape.Channel#onManagerVolumeChange
         ...
         * @private
         * @function
         * @name ape.Channel#onManagerSuspend
         ...
         * @private
         * @function
         * @name ape.Channel#onManagerResume
