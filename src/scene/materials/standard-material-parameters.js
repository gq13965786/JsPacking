(function () {
    //
    ape.StandardMaterial.PARAMETER_TYPES = {
        name: 'string',
        chunks: 'chunks',
    ...
    var key, type;
    ape.StandardMaterial.TEXTURE_PARAMETERS = [];
    for (key in ape.StandardMaterial.PARAMETER_TYPES) {
        type = ape.StandardMaterial.PARAMETER_TYPES[key];
        if (type === 'texture') {
            ape.StandardMaterial.TEXTURE_PARAMETERS.push(key);
        }
    }

    ape.StandardMaterial.CUBEMAP_PARAMETERS = [];
    for (key in ape.StandardMaterial.PARAMETER_TYPES) {
        type = ape.StandardMaterial.PARAMETER_TYPES[key];
        if (type === 'cubemap') {
            ape.StandardMaterial.CUBEMAP_PARAMETERS.push(key);
        }
    }
