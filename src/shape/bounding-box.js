Object.assign (ape, function() {
  ...
  Object.assign(BoundingBox.prototype, {
    ...
    clone: function () {
      return new ape.BoundingBox(this.center.clone(), this.halfExtents.clone());
    },
    ...
    getMax: function () {
      return this._max.copy(this.center).sub(this.halfExtents);
    },
