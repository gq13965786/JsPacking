Object.assign(ape, function () {
  var viewProj = new ape.Mat4();

  var Frustum = function Frustum(projectionMatrix, viewMatrix) {
    projectionMatrix = projectionMatrix || new ape.Mat4().setPerspective(90, 16/9, 0.1, 1000);
    viewMatrix = viewMatrix || new ape.Mat4();
  ...
  Object.assign(Frustum.prototype, {
    ...
    contiansSphere: function (sphere) {
      var c = 0;
      var d;
      var p;
